...
**landing-page branch: sync + box layout fix**
- Synced missing files from main: README.md, HANDOFF.md, blog.html, blog.css, player-frame.html.
- Updated nav.js and nav.css to main's versions (full music player, blog nav entry, all bug fixes).
- Fixed box stretching/off-screen bug in index.html: removed overflow:hidden, changed height:100vh to min-height:100vh on #site, added overflow-x:auto to btn-grid container, added max-width to landing-main.
