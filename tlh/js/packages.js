...
} from './data/packages.js?v=096-10-22';
import { cellKeyFromCoords, snapInteriorCell, mesaOutcropAt, terrainAt, MESA_OUTCROP_CENTERS } from './data/terrain.js?v=096-10-22';
import { placedGearAt, autoPlaceForCell, visiblePlacedGear } from './gear.js?v=096-10-22';
import { emit as tEmit, accum as tAccum } from './telemetry.js?v=096-10-22';
import { postActivity, shortPorterId, postLostDrop } from './multiplayer.js?v=096-10-22';
...
import { addTrust } from './trust.js?v=096-10-22';
import { cartFits, pushToCart } from './carrier.js?v=096-10-22';
...
import { sandalCap, renderBoots } from './boots.js?v=096-10-22';
import { addLog } from './render/log.js?v=096-10-22';
import { renderCourierStack, renderCargoSlots } from './render/hud.js?v=096-10-22';
import { courierXY, pointInRing, distanceKmToNode } from './render/route-map.js?v=096-10-22';
...
// `import * as Pkg from './packages.js?v=096-10-22'` consumers keep working.
...
// `import * as Pkg from './packages.js?v=096-10-22'` consumers keep working.
// ============================================================
export { tryDeliver } from './packages-delivery.js?v=096-10-22';
