...
} from './data/packages.js?v=097-0-9';
import { cellKeyFromCoords, snapInteriorCell, mesaOutcropAt, terrainAt, MESA_OUTCROP_CENTERS } from './data/terrain.js?v=097-0-9';
import { placedGearAt, autoPlaceForCell, visiblePlacedGear } from './gear.js?v=097-0-9';
import { emit as tEmit, accum as tAccum } from './telemetry.js?v=097-0-9';
import { postActivity, shortPorterId, postLostDrop, formatPorterFreshness } from './multiplayer.js?v=097-0-9';
...
import { addTrust } from './trust.js?v=097-0-9';
import { cartFits, pushToCart } from './carrier.js?v=097-0-9';
...
import { sandalCap, renderBoots } from './boots.js?v=097-0-9';
import { addLog } from './render/log.js?v=097-0-9';
import { noteFound as cargoNoteFound } from './render/cargo-log.js?v=097-0-9';
import { renderCourierStack, renderCargoSlots } from './render/hud.js?v=097-0-9';
import { courierXY, pointInRing, distanceKmToNode } from './render/route-map.js?v=097-0-9';
...
// `import * as Pkg from './packages.js?v=097-0-9'` consumers keep working.
...
// `import * as Pkg from './packages.js?v=097-0-9'` consumers keep working.
// ============================================================
export { tryDeliver } from './packages-delivery.js?v=097-0-9';
