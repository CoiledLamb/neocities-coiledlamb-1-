...
} from './data/packages.js?v=096-10-21';
import { cellKeyFromCoords, snapInteriorCell, mesaOutcropAt, terrainAt, MESA_OUTCROP_CENTERS } from './data/terrain.js?v=096-10-21';
import { placedGearAt, autoPlaceForCell, visiblePlacedGear } from './gear.js?v=096-10-21';
import { emit as tEmit, accum as tAccum } from './telemetry.js?v=096-10-21';
import { postActivity, shortPorterId, postLostDrop } from './multiplayer.js?v=096-10-21';
...
import { addTrust } from './trust.js?v=096-10-21';
import { cartFits, pushToCart } from './carrier.js?v=096-10-21';
...
import { sandalCap, renderBoots } from './boots.js?v=096-10-21';
import { addLog } from './render/log.js?v=096-10-21';
import { renderCourierStack, renderCargoSlots } from './render/hud.js?v=096-10-21';
import { courierXY, pointInRing, distanceKmToNode } from './render/route-map.js?v=096-10-21';
...
// `import * as Pkg from './packages.js?v=096-10-21'` consumers keep working.
...
// `import * as Pkg from './packages.js?v=096-10-21'` consumers keep working.
// ============================================================
export { tryDeliver } from './packages-delivery.js?v=096-10-21';
