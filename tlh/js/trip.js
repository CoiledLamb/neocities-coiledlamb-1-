...
import { postLostDrop } from './multiplayer.js?v=096-10-22';
import { staminaSegCount } from './stamina.js?v=096-10-22';
...
import { onInventoryChange } from './packages.js?v=096-10-22';
import { addLog } from './render/log.js?v=096-10-22';
import { renderCourierStack, renderCargoSlots } from './render/hud.js?v=096-10-22';
import { weatherAtCourier } from './weather.js?v=096-10-22';
import { courierXY, courierTerrain, beginRiverDrift } from './render/route-map.js?v=096-10-22';
import {
  TERRAIN_TRIP_MULT,
  TERRAIN_HAS_SEVERE,
  SEVERITY_SCALE,
...
import { placedGearAt } from './gear.js?v=096-10-22';
