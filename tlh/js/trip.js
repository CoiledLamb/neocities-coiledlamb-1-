...
import { postLostDrop } from './multiplayer.js?v=097-0-1';
import { staminaSegCount } from './stamina.js?v=097-0-1';
...
import { courierXY, courierTerrain, beginRiverDrift } from './render/route-map.js?v=097-0-1';
import {
  TERRAIN_TRIP_MULT,
  TERRAIN_HAS_SEVERE,
  SEVERITY_SCALE,
