...
import { tick } from './main.js?v=096-10-22';
import { buildWorld } from './world.js?v=096-10-22';
import { initWeather } from './weather.js?v=096-10-22';
import { setSilent, isSilent } from './multiplayer.js?v=096-10-22';
import {
  startCollection, stopCollection, emit, sample, series, accum, isActive as telemetryActive,
} from './telemetry.js?v=096-10-22';
import { aggregateReports } from './sim-stats.js?v=096-10-22';
...
import { seedInteriorPkgs } from './packages.js?v=096-10-22';
