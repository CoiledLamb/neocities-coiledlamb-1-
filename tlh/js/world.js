...
import { rollPkg, rollDestForSpawn, pickupRange, tryCursorPickup, formatPkgTooltip, formatPkgTooltipHTML } from './packages.js?v=097-0-6';
import { isOnShortcut } from './render/route-map.js?v=097-0-6';
...
export function buildWorld() {
  ...
  import('./packages.js?v=097-0-6').then(({ seedInteriorPkgs }) => {
