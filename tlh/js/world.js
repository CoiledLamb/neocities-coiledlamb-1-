...
import { rollPkg, rollDestForSpawn, pickupRange, tryCursorPickup, formatPkgTooltip, formatPkgTooltipHTML } from './packages.js?v=096-10-22';
import { isOnShortcut } from './render/route-map.js?v=096-10-22';
import { showRichTooltip, hideRichTooltip, activeRichTooltipId } from './render/rich-tooltip.js?v=096-10-22';
...
export function buildWorld() {
  ...
  import('./packages.js?v=096-10-22').then(({ seedInteriorPkgs }) => {
