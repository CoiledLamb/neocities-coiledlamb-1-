...
import { rollPkg, rollDestForSpawn, pickupRange, tryCursorPickup, formatPkgTooltip, formatPkgTooltipHTML } from './packages.js?v=097-0-8';
import { isOnShortcut } from './render/route-map.js?v=097-0-8';
import { showRichTooltip, hideRichTooltip, activeRichTooltipId } from './render/rich-tooltip.js?v=097-0-8';
...
export function buildWorld() {
  ...
  import('./packages.js?v=097-0-8').then(({ seedInteriorPkgs }) => {
