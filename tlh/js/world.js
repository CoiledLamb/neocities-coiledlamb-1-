...
import { rollPkg, rollDestForSpawn, pickupRange, tryCursorPickup, formatPkgTooltip, formatPkgTooltipHTML } from './packages.js?v=096-10-18';
import { isOnShortcut } from './render/route-map.js?v=096-10-18';
...
export function buildWorld() {
  ...
  import('./packages.js?v=096-10-18').then(({ seedInteriorPkgs }) => {
