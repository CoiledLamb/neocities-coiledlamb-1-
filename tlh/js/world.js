...
import { rollPkg, rollDestForSpawn, pickupRange, tryCursorPickup, formatPkgTooltip, formatPkgTooltipHTML } from './packages.js?v=096-10-20';
import { isOnShortcut } from './render/route-map.js?v=096-10-20';
...
export function buildWorld() {
  ...
  import('./packages.js?v=096-10-20').then(({ seedInteriorPkgs }) => {
