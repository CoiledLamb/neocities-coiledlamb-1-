...
import { rollPkg, rollDestForSpawn, pickupRange, tryCursorPickup, formatPkgTooltip, formatPkgTooltipHTML } from './packages.js?v=096-10-21';
import { isOnShortcut } from './render/route-map.js?v=096-10-21';
import { showRichTooltip, hideRichTooltip, activeRichTooltipId } from './render/rich-tooltip.js?v=096-10-21';
...
export function buildWorld() {
  ...
  import('./packages.js?v=096-10-21').then(({ seedInteriorPkgs }) => {
