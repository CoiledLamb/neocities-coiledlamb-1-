...
import { postActivity } from './multiplayer.js?v=097-0-8';
import { emit as tEmit, accum as tAccum, markFirst as tMarkFirst } from './telemetry.js?v=097-0-8';
import { getNodeStage, setNodeStage, getDisplayLabel } from './identification.js?v=097-0-8';
import { speak } from './channels.js?v=097-0-8';
import { pickRandom } from './util.js?v=097-0-8';
import { staminaSegCount, renderStamina } from './stamina.js?v=097-0-8';
import { addLog } from './render/log.js?v=097-0-8';
import { updateHUD } from './render/hud.js?v=097-0-8';
