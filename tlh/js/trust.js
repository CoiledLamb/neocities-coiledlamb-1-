...
import { postActivity } from './multiplayer.js?v=097-0-9';
import { emit as tEmit, accum as tAccum, markFirst as tMarkFirst } from './telemetry.js?v=097-0-9';
import { getNodeStage, setNodeStage, getDisplayLabel } from './identification.js?v=097-0-9';
import { speak } from './channels.js?v=097-0-9';
import { pickRandom } from './util.js?v=097-0-9';
import { staminaSegCount, renderStamina } from './stamina.js?v=097-0-9';
import { addLog } from './render/log.js?v=097-0-9';
import { updateHUD } from './render/hud.js?v=097-0-9';
import { drawRouteMap } from './render/route-map.js?v=097-0-9';
import { renderSettlements } from './render/settlements.js?v=097-0-9';
import { weatherAtCourier } from './weather.js?v=097-0-9';
