...
import { UPGRADE_DEFS } from './data/upgrades.js?v=097-0-13';
import { postActivity } from './multiplayer.js?v=097-0-13';
import { emit as tEmit, accum as tAccum, markFirst as tMarkFirst } from './telemetry.js?v=097-0-13';
import { getNodeStage, setNodeStage, getDisplayLabel } from './identification.js?v=097-0-13';
import { speak } from './channels.js?v=097-0-13';
import { pickRandom } from './util.js?v=097-0-13';
import { staminaSegCount, renderStamina } from './stamina.js?v=097-0-13';
import { addLog } from './render/log.js?v=097-0-13';
import { updateHUD } from './render/hud.js?v=097-0-13';
import { drawRouteMap } from './render/route-map.js?v=097-0-13';
import { renderSettlements } from './render/settlements.js?v=097-0-13';
import { weatherAtCourier } from './weather.js?v=097-0-13';
