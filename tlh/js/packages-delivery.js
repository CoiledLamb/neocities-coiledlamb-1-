...
import { postActivity, shortPorterId } from './multiplayer.js?v=096-10-22';
import { updatePorterStripBadges } from './recovery.js?v=096-10-22';
import { addTrust, computeTrustGain, speakDelivery } from './trust.js?v=096-10-22';
import { removeFromInventories } from './carrier.js?v=096-10-22';
import { getNodeStage, setNodeStage } from './identification.js?v=096-10-22';
