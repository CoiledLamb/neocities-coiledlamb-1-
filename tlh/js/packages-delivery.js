...
import { NPC_DEFS } from './data/npc-defs.js?v=096-10-21';
import { emit as tEmit, accum as tAccum } from './telemetry.js?v=096-10-21';
import { postActivity, shortPorterId } from './multiplayer.js?v=096-10-21';
import { updatePorterStripBadges } from './recovery.js?v=096-10-21';
import { addTrust, computeTrustGain, speakDelivery } from './trust.js?v=096-10-21';
import { removeFromInventories } from './carrier.js?v=096-10-21';
import { getNodeStage, setNodeStage } from './identification.js?v=096-10-21';
