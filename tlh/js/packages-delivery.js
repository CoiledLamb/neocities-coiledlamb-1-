...
import { emit as tEmit, accum as tAccum } from './telemetry.js?v=097-0-7';
import { postActivity, shortPorterId } from './multiplayer.js?v=097-0-7';
import { updatePorterStripBadges } from './recovery.js?v=097-0-7';
import { addTrust, computeTrustGain, speakDelivery } from './trust.js?v=097-0-7';
import { removeFromInventories } from './carrier.js?v=097-0-7';
import { getNodeStage, setNodeStage } from './identification.js?v=097-0-7';
import { addLog } from './render/log.js?v=097-0-7';
import { noteDelivered as cargoNoteDelivered } from './render/cargo-log.js?v=097-0-7';
