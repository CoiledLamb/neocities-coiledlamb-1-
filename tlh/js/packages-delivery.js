...
import { postActivity, shortPorterId } from './multiplayer.js?v=096-10-18';
import { updatePorterStripBadges } from './recovery.js?v=096-10-18';
import { addTrust, computeTrustGain, speakDelivery } from './trust.js?v=096-10-18';
import { removeFromInventories } from './carrier.js?v=096-10-18';
import { getNodeStage, setNodeStage } from './identification.js?v=096-10-18';
...
import { onInventoryChange } from './packages.js?v=096-10-18';
