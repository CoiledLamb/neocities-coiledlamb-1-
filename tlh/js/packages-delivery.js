...
import { postActivity, shortPorterId } from './multiplayer.js?v=097-0-6';
import { updatePorterStripBadges } from './recovery.js?v=097-0-6';
import { addTrust, computeTrustGain, speakDelivery } from './trust.js?v=097-0-6';
import { removeFromInventories } from './carrier.js?v=097-0-6';
import { getNodeStage, setNodeStage } from './identification.js?v=097-0-6';
import { addLog } from './render/log.js?v=097-0-6';
import { noteDelivered as cargoNoteDelivered } from './render/cargo-log.js?v=097-0-6';
import { renderCourierStack, renderCargoSlots } from './render/hud.js?v=097-0-6';
import { drawRouteMap } from './render/route-map.js?v=097-0-6';
import { renderSettlements } from './render/settlements.js?v=097-0-6';
import { onInventoryChange } from './packages.js?v=097-0-6';
