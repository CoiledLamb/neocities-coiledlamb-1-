...
import { drawRouteMap, updateRouteDot } from './render/route-map.js?v=097-0-3';
...
import { adminToggleStorm, weatherAtCourier } from './weather.js?v=097-0-3';
...
function dispatch(cmd, args) {
  switch (cmd) {
    ...
    case 'sim': {
      ...
      return import('./sim.js?v=097-0-3').then(mod => {
    ...
    case 'simBatch': {
      return import('./sim.js?v=097-0-3').then(async mod => {
