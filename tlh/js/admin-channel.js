...
import { drawRouteMap, updateRouteDot } from './render/route-map.js?v=097-0-2';
...
import { adminToggleStorm, weatherAtCourier } from './weather.js?v=097-0-2';
...
function dispatch(cmd, args) {
  switch (cmd) {
    ...
    case 'sim': {
      ...
      return import('./sim.js?v=097-0-2').then(mod => {
    ...
    case 'simBatch': {
      return import('./sim.js?v=097-0-2').then(async mod => {
