...
import { updateHUD, renderCargoSlots, renderCourierStack } from './render/hud.js?v=097-0-12';
import { renderSettlements } from './render/settlements.js?v=097-0-12';
import { drawRouteMap, updateRouteDot } from './render/route-map.js?v=097-0-12';
...
import { adminToggleStorm, weatherAtCourier } from './weather.js?v=097-0-12';
...
function dispatch(cmd, args) {
  switch (cmd) {
    ...
    case 'sim': {
      ...
      return import('./sim.js?v=097-0-12').then(mod => {
    ...
    case 'simBatch': {
      return import('./sim.js?v=097-0-12').then(async mod => {
