...
import { drawRouteMap, updateRouteDot } from './render/route-map.js?v=097-0-8';
...
import { adminToggleStorm, weatherAtCourier } from './weather.js?v=097-0-8';
...
function dispatch(cmd, args) {
  switch (cmd) {
    ...
    case 'sim': {
      ...
      return import('./sim.js?v=097-0-8').then(mod => {
    ...
    case 'simBatch': {
      return import('./sim.js?v=097-0-8').then(async mod => {
