...
import { drawRouteMap, updateRouteDot } from './render/route-map.js?v=096-10-15';
...
import { adminToggleStorm, weatherAtCourier } from './weather.js?v=096-10-15';
...
function dispatch(cmd, args) {
  switch (cmd) {
    ...
    case 'sim': {
      ...
      return import('./sim.js?v=096-10-15').then(mod => {
    ...
    case 'simBatch': {
      return import('./sim.js?v=096-10-15').then(async mod => {
