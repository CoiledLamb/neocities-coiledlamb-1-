...
import { updateHUD, renderCargoSlots, renderCourierStack } from './render/hud.js?v=097-0-11';
import { renderSettlements } from './render/settlements.js?v=097-0-11';
import { drawRouteMap, updateRouteDot } from './render/route-map.js?v=097-0-11';
...
import { adminToggleStorm, weatherAtCourier } from './weather.js?v=097-0-11';
...
function dispatch(cmd, args) {
  switch (cmd) {
    ...
    case 'sim': {
      ...
      return import('./sim.js?v=097-0-11').then(mod => {
    ...
    case 'simBatch': {
      return import('./sim.js?v=097-0-11').then(async mod => {
