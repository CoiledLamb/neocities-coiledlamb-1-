...
import { updateHUD, renderCargoSlots, renderCourierStack } from './render/hud.js?v=096-10-18';
import { renderSettlements } from './render/settlements.js?v=096-10-18';
import { drawRouteMap, updateRouteDot } from './render/route-map.js?v=096-10-18';
...
import { adminToggleStorm, weatherAtCourier } from './weather.js?v=096-10-18';
...
function dispatch(cmd, args) {
  switch (cmd) {
    ...
    case 'sim': {
      ...
      return import('./sim.js?v=096-10-18').then(mod => {
    ...
    case 'simBatch': {
      return import('./sim.js?v=096-10-18').then(async mod => {
