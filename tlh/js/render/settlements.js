...
import { NPC_DEFS, NPC_VISIT_ORDER } from '../data/npc-defs.js?v=097-0-10';
import { getNodeStage } from '../identification.js?v=097-0-10';
import { getNpc } from '../trust.js?v=097-0-10';
