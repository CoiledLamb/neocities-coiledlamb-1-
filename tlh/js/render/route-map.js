...
import { getNodeStage, getDisplayLabel } from '../identification.js?v=097-0-13';
import { TICKS_PER_DAY } from './sky.js?v=097-0-13';
...
import { visiblePlacedGear, placedGearAt } from '../gear.js?v=097-0-13';
import { speedMultiplier } from '../stamina.js?v=097-0-13';
import { showRichTooltip, hideRichTooltip } from './rich-tooltip.js?v=097-0-13';
import { tlhPalette } from '../palette.js?v=097-0-13';
import { bakeSteppedHypsoPng } from '../data/topo-map.js?v=097-0-13';
...
import { currentEdge } from '../segment.js?v=097-0-13';
