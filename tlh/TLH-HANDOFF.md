...
_last updated: 2026-05-03 (**v0.0.9.7.9 — porter-ring + topo alignment.** Trample + auto-place-gear on the ring now gated to mesa outcrops only — fixes the long-running-save artifact where xi's corner plateau (PLATEAU_R 55) bled into ring segments gamma↔xi↔delta and accumulated trample/ladders inward of the ring polygon. Design intent locked: "porter doesn't seek mesas while on the ring; if they cross one in the interior, they engage it." Stream tributaries in terrain.js aligned to topo-map.js's STREAM_CTRLS — 4 streams sampled into 14 short straight segments so the visible streams classify gameplay-wise as river/clayBed where players see them. Topo's 3 NW desert mesas left as-is (interior visual scenery, no porter seeking). Cache-bust 097-0-9. Kitchen design sketch still queued for v0.0.9.8 — see [v0.0.9.8 design sketch — the kitchen](#v0098-design-sketch--the-kitchen-in-flight-2026-05-03).)_
