...
## ✅ CURRENT STATE: v0.0.9.5 shipped (+ .5.1-.5.4 polish) + v0.0.9.6 commits 1-5 (terrain bones, label normalization, shortcut rewrite + severe trips, ladder + anchor gear, world-overlay + pkg-origin schema v9 + interior spawns) + .6.1/.6.2 polish passes; v0.0.9.6 commit 6 of 7 (placement UX + trails + pass carving) in flight
