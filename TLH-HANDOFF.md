...
## ✅ CURRENT STATE: v0.0.9.5 shipped (+ .5.1-.5.4 polish) + v0.0.9.6 commits 1-4 (terrain bones, label normalization, shortcut rewrite + severe trips, ladder + anchor gear) + .6.1/.6.2 polish passes; v0.0.9.6 commit 5 of 7 (world-overlay + pkg-origin schema + interior spawns) in flight
